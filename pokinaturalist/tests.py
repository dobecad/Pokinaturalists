...
class DatabaseTests(TestCase):
    ...
    def test_creature_creation(self):
        ...
        test3 = Creature(owner_id=test2, nickname="Pikachu",
                         observation_icon="Pokemon num 25", observation_wiki="Pokemon num 25", strength=1337)
    ...
    def test_multiple_creature(self):
        ...
        test2 = User.objects.get(username="Ash Ketchum")
        test3 = Creature(owner_id=test2, nickname="Pikachu",
                         observation_icon="Defibrillator", observation_wiki="Pokemon num 25", strength=1337)
        test4 = Creature(owner_id=test2, nickname="Charizard",
                         observation_icon="Blaze it", observation_wiki="Pokemon num 6", strength=420)
        test3.save()
        test4.save()
